    ...
    # -------------------------------------------------------------------------
    {
        ...
        "steps": [
            ...
            },
            {
                "sequence": 2,
                "title": "Navigation",
                "description": "Every HR module is accessible from this sidebar — Attendance, Leave, Payroll, Recruitment and more.",
            ...
            },
            {
                ...
                "description": "Use the Create button to add a new employee manually, or Import to bulk-upload from an Excel or CSV file.",
                "element_selector": "",
                "side": "over",
                "align": "start",
            },
            {
                "sequence": 4,
                "title": "Filter & search",
                "description": "Narrow the list by department, job position, manager or employment status. Filters are remembered between visits.",
                "element_selector": "",
                "side": "over",
                "align": "start",
            },
            {
                ...
                "description": "Click any employee card to open their full profile — personal info, documents, attendance history, payslips and more.",
                "element_selector": "",
                "side": "over",
                "align": "start",
            },
        ...
        "steps": [
            {
                ...
                "description": "Candidates move through stages — Applied, Shortlisted, Interview, Offer, Hired. Each column is one stage.",
                "element_selector": "",
                "side": "over",
                "align": "start",
            },
            {
                "sequence": 2,
                "title": "Kanban board",
                "description": "Each column is a hiring stage. Drag a candidate card across columns to advance them — each move is logged automatically.",
            ...
            },
            {
                ...
                "description": "Click any card to open the full candidate profile — resume, interview scores, notes and activity history.",
                "element_selector": "",
                "side": "over",
                "align": "start",
            },
            {
                ...
                "description": "From the candidate profile you can send shortlist emails, schedule interviews and record assessments — all in one place.",
                "element_selector": "",
                "side": "over",
                "align": "start",
            },
            {
                "sequence": 5,
                "title": "Open Jobs page",
                "description": "Share the public job listing page with applicants. New applications land automatically in the first pipeline stage.",
                "element_selector": "",
                "side": "over",
                "align": "start",
            },
