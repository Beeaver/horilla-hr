...
class Tour(HorillaModel):
    ...
    slug = models.SlugField(
        max_length=120,
        verbose_name=_("Key"),
        help_text=_("Stable identifier used in code/seed data, e.g. 'getting-started'."),
    )
    ...
    priority = models.IntegerField(
        ...
        help_text=_("Higher priority tours auto-start first when several match a page."),
    )
    show_progress = models.BooleanField(default=True, verbose_name=_("Show progress bar"))
...
class TourStep(HorillaModel):
    ...
    side = models.CharField(
        max_length=10, choices=SIDE_CHOICES, default="bottom", verbose_name=_("Position")
    )
